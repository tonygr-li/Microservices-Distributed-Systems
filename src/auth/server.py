import jws, datetime, os
from flask import Flask, request 
from flask_mysqldb import MySQL

server = Flask(__name__) # create server
mysql = MySQL(server) # connect to db

#config
server.config["MYSQL_HOST"] = os.environ.get("MYSQL_HOST") # get from env (localhost)
...
def validate():
    ...
    encoded_jwt = encoded_jwt.split(" ")[1] # bearer type
